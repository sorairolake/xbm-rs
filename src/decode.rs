...
impl<R: BufRead + Seek> Decoder<R> {
    ...
    /// Returns the _x_ coordinate of the hotspot, or [`None`] if the value is not defined.
    ///
    /// # Examples
    ///
    /// ```
    ...
    /// Returns the _y_ coordinate of the hotspot, or [`None`] if the value is not defined.
    ///
    /// # Examples
    ///
    /// ```
